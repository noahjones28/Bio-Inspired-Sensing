function dSTdq_FC = compute_dSTdqFC_Z4(h,Omega,Phi_Z1,Phi_Z2,Z,T,f,fd,adjOmegap,F_C)

dSTdq_FC = sqrt(3)/12*h^2*(Phi_Z1'*dinamico_coadjbar(T'*F_C)*Phi_Z2-Phi_Z2'*dinamico_coadjbar(T'*F_C)*Phi_Z1);
