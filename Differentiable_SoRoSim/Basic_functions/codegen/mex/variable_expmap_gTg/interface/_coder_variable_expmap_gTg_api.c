 ...
 *
 * _coder_variable_expmap_gTg_api.c
 *
 * Code generation for function '_coder_variable_expmap_gTg_api'
 *
 */
...
void variable_expmap_gTg_api(const mxArray *prhs, int32_T nlhs,
                             const mxArray *plhs[2])
{
  ...
  variable_expmap_gTg(*Omega, *g, *Tg);
...
/* End of code generation (_coder_variable_expmap_gTg_api.c) */
