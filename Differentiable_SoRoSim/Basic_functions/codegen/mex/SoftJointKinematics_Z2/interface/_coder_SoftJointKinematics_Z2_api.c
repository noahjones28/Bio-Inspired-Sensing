 ...
 *
 * _coder_SoftJointKinematics_Z2_api.c
 *
 * Code generation for function '_coder_SoftJointKinematics_Z2_api'
 *
 */
...
void SoftJointKinematics_Z2_api(const mxArray *const prhs[4], int32_T nlhs,
                                const mxArray *plhs[8])
{
  ...
  *(real_T **)&Phi_Z_data =
  ...
  xi_star = e_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "xi_star");
  *(real_T **)&q_data =
      g_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "q", &q_size);
  /* Invoke the target function */
  SoftJointKinematics_Z2(&st, h, *Phi_Z_data, Phi_Z_size, *xi_star, *q_data,
...
/* End of code generation (_coder_SoftJointKinematics_Z2_api.c) */
