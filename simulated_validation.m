function simulated_validation()
% SIMULATED_VALIDATION  Compare Jacobian conditioning of cylindrical vs.
...
tau_range     = [0, 3];
s_sep_min     = 0.02;
results_file  = 'simulated_validation_results.xlsx';
...
function plot_validation(sep_ct, k_ct, sep_cu, k_cu, sep_ot, k_ot, sep_ou, k_ou)
    ...
    exportgraphics(gcf, 'simulated_validation.png', 'Resolution', 300, 'BackgroundColor', 'none');
    fprintf('\nPlot saved to simulated_validation.png\n');
end
