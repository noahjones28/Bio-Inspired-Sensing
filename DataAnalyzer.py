...
class DataAnalyzer:
    ...
    def load_samples_from_array(self):
        ...
        distal_values = np.array([
            [0.713, 0.040,  1.571, -3.142, 1.190, 0.000, 0.000],
            [0.420, 0.100,  1.571, -3.142, 0.000, 0.000, 0.950],
            [0.852, 0.060,  1.571, -3.142, 0.000, 0.694, 0.000],
            [0.611, 0.100,  1.571, -3.142, 0.000, 0.000, 1.286],
            [0.658, 0.040,  1.571,  0.000, 0.397, 0.000, 0.000],
            [0.363, 0.180,  1.571,  0.000, 0.000, 1.339, 0.000],
            [0.216, 0.040, -1.571,  0.000, 1.106, 0.000, 0.000],
            [0.166, 0.100, -1.571,  0.000, 0.962, 0.000, 0.000],
            [0.184, 0.120, -1.571,  0.000, 0.000, 0.894, 0.000],
            [0.961, 0.140, -1.571,  0.000, 0.000, 0.000, 1.244],
            [0.510, 0.060, -1.571, -3.142, 0.000, 0.000, 0.808],
            [0.309, 0.120, -1.571,  0.000, 0.000, 0.871, 0.000],
            [0.897, 0.200, -1.571, -3.142, 1.266, 0.000, 0.000],
            [0.204, 0.200, -1.571,  0.000, 0.000, 1.315, 0.000],
            [0.783, 0.160, -1.571,  0.000, 1.344, 0.000, 0.000],
        ])
